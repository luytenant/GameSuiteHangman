...
public class OmhullendeTest {
	...
	@Test
	public void getMinimumX_geeft_minimum_van_X(){
		Omhullende omhullende = new Omhullende(linkerBovenhoek, breedte, hoogte);
		assertEquals(omhullende.getLinkerBovenhoek().getX(), omhullende.getMinX());
	}
	@Test
	public void getMinimumX_geeft_minimum_van_Y(){
		Omhullende omhullende = new Omhullende(linkerBovenhoek, breedte, hoogte);
		assertEquals(omhullende.getLinkerBovenhoek().getY(), omhullende.getMinY());
	}
	@Test
	public void getMaximumX_geeft_maximum_van_X(){
		Omhullende omhullende = new Omhullende(linkerBovenhoek, breedte, hoogte);
		assertEquals(omhullende.getLinkerBovenhoek().getX() + breedte, omhullende.getMaxX());
	}
	@Test
	public void getMaximumX_geeft_maximum_van_Y(){
		Omhullende omhullende = new Omhullende(linkerBovenhoek, breedte, hoogte);
		assertEquals(omhullende.getLinkerBovenhoek().getY() + hoogte, omhullende.getMaxY());
	}
}
